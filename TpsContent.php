...
//		}
	...
	public static function the_content( $content ) {
		...
		// Add slider HTML.
		{
			...
			// Top slider
			if ( in_array( TpsPostOptions::get( $post->ID, 'nav_vertical_position', 'tps_nav' ), array( 'top_and_bottom', 'top' ) ) ) {
			...
			// Bottom slider
			if ( in_array( TpsPostOptions::get( $post->ID, 'nav_vertical_position', 'tps_nav' ), array( 'top_and_bottom', 'bottom' ) ) ) {
				$html .= TpsNavigationBar::get_navigation_bar( array(
					'currentSlide' => $page,
					'totalSlides'  => count( $pages ),
					'prevPostUrl'  => $post->theiaPostSlider['prevPostUrl'],
